...
public class HomeRecipesAdapter extends RecyclerView.Adapter<HomeRecipesAdapter.ViewHolder>{

    private ArrayList<BoardVO> items;
    private Context context;

    public HomeRecipesAdapter(ArrayList<BoardVO> items){
        this.items = items;
    }//생성자
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int position) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_recipes_home,parent,false);
